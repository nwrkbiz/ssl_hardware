...
# Thu Dec 06 22:46:23 CET 2018
# DO NOT MODIFY


# 
# HDC1000 "HDC1000" v1.0
# Elias Geissler 2018.12.06.22:46:23
...
add_fileset_file RegFileHDC1000.vhd VHDL PATH ../../HDC1000/src/RegFileHDC1000.vhd
...
# 
# connection point hdc1000
# 
add_interface hdc1000 conduit end
set_interface_property hdc1000 associatedClock clock_sink
set_interface_property hdc1000 associatedReset ""
set_interface_property hdc1000 ENABLED true
set_interface_property hdc1000 EXPORT_OF ""
set_interface_property hdc1000 PORT_NAME_MAP ""
set_interface_property hdc1000 CMSIS_SVD_VARIABLES ""
set_interface_property hdc1000 SVD_ADDRESS_GROUP ""

add_interface_port hdc1000 inDataReady drdy_n Input 1
...
set_interface_property interrupt associatedClock clock_sink
...
add_interface_port interrupt oDataAvailable irq Output 1
